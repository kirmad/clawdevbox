...
- `incidents.resolve_incident` (and any equivalent in other plugins) —
  declaring an incident resolved is a human decision.
- `incidents.transfer_incident`, `incidents.activate_incident` — routing/reactivation.
...
- **Always-allowed (bypass budget):**
  - Sev 1 / Sev 2 incident page (Incidents or equivalent).
