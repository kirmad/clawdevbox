  ...
  return JSON.stringify(
    {
      ...
      icons: [
        // PNG first — iOS + Android WebAPK minting need real PNG 192/512
        // icons; SVG-only installs fall back to a browser shortcut / generic
        // icon. SVG kept last as a crisp fallback for browsers that prefer it.
...
const CACHE = 'clawdevbox-shell-v4';
const SHELL = ['/', '/manifest.webmanifest', '/icon.svg', '/icon-maskable.svg', '/icon-192.png', '/icon-512.png', '/icon-maskable-512.png', '/apple-touch-icon.png'];
