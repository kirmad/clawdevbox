...
export default {
  type: 'pr-review',
  // pr-review ships its own per-line / per-comment UI inside the file
  // browser — a second universal comment overlay sidebar would duplicate
  // that affordance and confuse users about which path is authoritative.
  // Opt out.
  comments: false,
