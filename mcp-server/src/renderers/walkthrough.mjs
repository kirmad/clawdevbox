...
const STYLES = `
  ...
  .wt-overview-card { background: #252526; border: 1px solid #4d4d4d; border-radius: 8px; max-width: 80vw; max-height: 85vh; overflow: auto; padding: 18px 22px; }
  ...
  .wt-overview-card .arch { background: #1b1b1b; border: 1px solid #3e3e42; border-radius: 4px; padding: 8px; overflow: auto; }
