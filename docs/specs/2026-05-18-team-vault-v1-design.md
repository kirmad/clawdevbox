...
parent_vault:                  # null for root vault
  git_url: git@github.com:org/team-vault.git
...
```json
{
  ...
  "clawdevbox_workspaces_root": "/Users/devuser/.clawdevbox/workspaces",
...
paths.get(args?: { workspace_id?: string }) → {
  workspace: {
    id: "ws_abc_1234",
    root: "/Users/devuser/.clawdevbox/workspaces/ws_abc_1234/.clawdevbox",
    memory: ".../memory",
    skills: ".../skills",
    recipes: ".../recipes",
  ...
  vaults: [
    {
      ...
      root: "/Users/devuser/.clawdevbox/vaults/personal",
      memory: ".../memory",
      skills: ".../skills",
      recipes: ".../recipes",
      triggers: ".../triggers",
    ...
    },
    {
      ...
      depth: 1,
      root: "/Users/devuser/.clawdevbox/vaults/feature-crew-alpha",
      memory: ".../memory",
      skills: ".../skills",
      // ... (same shape)
      has_remote: true
    },
    {
      id: "meetings",
      depth: 2,
      root: "/Users/devuser/.clawdevbox/vaults/meetings",
      // ... (same shape)
      has_remote: true
    }
  ],
  ...
  globals: {
    plugins: "/Users/devuser/.clawdevbox/plugins",
    config: "/Users/devuser/.clawdevbox/config.json"
  }
}
```
...
triggers/             @devuser
agents/               @devuser
.vault/audits/        @devuser
.vault/votes/         @devuser
.vault/disables/      @devuser
AGENTS.md             @devuser
vault.yaml            @devuser
CODEOWNERS            @devuser
```
...
[7/8] Initial CODEOWNERS: @devuser
...
[5/N]   ✗ You do not have push access to org/team-vault.
[5/N]   Options:
[5/N]     1. Use a fork (recommended). Create now? (y/N) > y
[5/N]   Created fork devuser/team-vault ✓
